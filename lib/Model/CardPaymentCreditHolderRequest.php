...
/**
 * CardPaymentCreditHolderRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CardPaymentCreditHolderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardPaymentCreditHolderRequest';
    ...
    protected static $setters = [
        ...
        'credit_ref' => 'setCreditRef',
        'credit_tag' => 'setCreditTag',
        'amount' => 'setAmount',
    ...
    protected static $getters = [
        ...
        'credit_ref' => 'getCreditRef',
        'credit_tag' => 'getCreditTag',
        'amount' => 'getAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['credit_ref'] = isset($data['credit_ref']) ? $data['credit_ref'] : null;
        $this->container['credit_tag'] = isset($data['credit_tag']) ? $data['credit_tag'] : null;
     ...
     * Sets merchant_id
     *
     * @param int|null $merchant_id The merchant identifier
     *
     * @return $this
     */
     ...
     *
     * @param string|null $merchant_site_id The merchant site identifier
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency of the order (ISO 4217)
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string|null $country The code of the country (ISO 3166-1 alpha-2)
     *
     * @return $this
     */
     ...
     * Sets customer_ref
     *
     * @param string|null $customer_ref The customer reference
     *
     * @return $this
     */
     ...
     * @return string|null
     */
    public function getCreditRef()
    {
        return $this->container['credit_ref'];
    }

    /**
     * Sets credit_ref
     *
     * @param string|null $credit_ref The order reference linked to the schedule and transaction
     *
     * @return $this
     */
    public function setCreditRef($credit_ref)
    {
        $this->container['credit_ref'] = $credit_ref;
     ...
     * @return string|null
     */
    public function getCreditTag()
    {
        return $this->container['credit_tag'];
    }

    /**
     * Sets credit_tag
     *
     * @param string|null $credit_tag The order tag is a label for the schedule
     *
     * @return $this
     */
    public function setCreditTag($credit_tag)
    {
        $this->container['credit_tag'] = $credit_tag;
     ...
     * Sets card_scheme
     *
     * @param string|null $card_scheme The card type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getCardSchemeAllowableValues();
        if (!is_null($card_scheme) && !in_array($card_scheme, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'card_scheme', must be one of '%s'",
                    implode("', '", $allowedValues)
