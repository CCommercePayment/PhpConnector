...
class DuplicatePaymentApi
{
     ...
     * @param  \OpenAPI\Client\Model\DuplicatePaymentBatchRequest $duplicate_payment_batch_request All data needed to make process the payment, with the reference to the previously payment. (optional)
     *
    ...
    {
        list($response) = $this->v1PaymentsDuplicatePaymentBatchPostWithHttpInfo($auth_token, $duplicate_payment_batch_request);
        return $response;
    }
     ...
     */
    public function v1PaymentsDuplicatePaymentBatchPostAsync($auth_token, $duplicate_payment_batch_request = null)
    {
        return $this->v1PaymentsDuplicatePaymentBatchPostAsyncWithHttpInfo($auth_token, $duplicate_payment_batch_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function v1PaymentsDuplicatePaymentBatchPostRequest($auth_token, $duplicate_payment_batch_request = null)
    {
        // verify the required parameter 'auth_token' is set
        if ($auth_token === null || (is_array($auth_token) && count($auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $auth_token when calling v1PaymentsDuplicatePaymentBatchPost'
            );
        }

        $resourcePath = '/v1/payments/duplicate-payment/batch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($duplicate_payment_batch_request)) {
            $_tempBody = $duplicate_payment_batch_request;
        }
     ...
     *
     * @param  string $auth_token Gets or sets the authentication token. (required)
     * @param  \OpenAPI\Client\Model\DuplicatePaymentRequest $duplicate_payment_request All data needed to make process the payment, with the reference to the previously payment. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CardPaymentResponse
    ...
    {
        list($response) = $this->v1PaymentsDuplicatePaymentPostWithHttpInfo($auth_token, $duplicate_payment_request);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1PaymentsDuplicatePaymentPostAsync($auth_token, $duplicate_payment_request = null)
    {
        return $this->v1PaymentsDuplicatePaymentPostAsyncWithHttpInfo($auth_token, $duplicate_payment_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function v1PaymentsDuplicatePaymentPostRequest($auth_token, $duplicate_payment_request = null)
    {
        // verify the required parameter 'auth_token' is set
        if ($auth_token === null || (is_array($auth_token) && count($auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $auth_token when calling v1PaymentsDuplicatePaymentPost'
            );
        }

        $resourcePath = '/v1/payments/duplicate-payment';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($duplicate_payment_request)) {
            $_tempBody = $duplicate_payment_request;
        }
