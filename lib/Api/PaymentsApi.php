...
class PaymentsApi
{
     ...
     * @return \OpenAPI\Client\Model\PaymentOperationsResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PaymentOperationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1PaymentsAllByOrderRefMerchantsByMerchantIdSitesByMerchantSiteIdGetWithHttpInfo($order_ref, $merchant_id, $merchant_site_id, $auth_token)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PaymentOperationsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PaymentOperationsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\PaymentOperationsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PaymentOperationsResponse',
     ...
     * @param  string $auth_token Gets or sets the authentication token. (required)
     * @param  \OpenAPI\Client\Model\PaymentOperationsRequest $payment_operation_request The payment operation request. Materialized by the Body of the PUT request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PaymentOperationsResponse
