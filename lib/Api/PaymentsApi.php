...
class PaymentsApi
{
     ...
     * @return \Cpayment.Connector\Model\PaymentOperationsResponse
     */
     ...
     * @throws \Cpayment.Connector\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cpayment.Connector\Model\PaymentOperationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1PaymentsAllByOrderRefMerchantsByMerchantIdSitesByMerchantSiteIdGetWithHttpInfo($order_ref, $merchant_id, $merchant_site_id, $auth_token)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cpayment.Connector\Model\PaymentOperationsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Cpayment.Connector\Model\PaymentOperationsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Cpayment.Connector\Model\PaymentOperationsResponse';
            $responseBody = $response->getBody();
     ...
     * @param  string $auth_token Gets or sets the authentication token. (required)
     * @param  \Cpayment.Connector\Model\PaymentOperationsRequest $payment_operation_request The payment operation request. Materialized by the Body of the PUT request (optional)
     *
     * @throws \Cpayment.Connector\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cpayment.Connector\Model\PaymentOperationsResponse
